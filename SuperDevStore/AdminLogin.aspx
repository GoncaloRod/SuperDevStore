...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        ...
        <!-- Font Awsome -->
        <link rel="stylesheet" href="css/fontawsome/fontawesome-all.min.css">
        <!-- Custom Style -->
        ...
        <form runat="server">
            ...
            <div id="alertsContainer" runat="server" style="width: 50%; margin-left: 25%;">
                <% foreach (var message in SuperDevStore.Alerts.successMessages) { %>
                    <div class="alert alert-success alert-dismissable fade show" style="position: absolute; width: inherit; margin-top: 5px; z-index: 1000;">
                ...
                <% foreach (var message in SuperDevStore.Alerts.errorMessages) { %>
                    <div class="alert alert-danger alert-dismissable fade show" style="position: absolute; width: inherit; margin-top: 5px; z-index: 1000;">
                        <button type="button" class="close" data-dismiss="alert">&times;</button>
                        <% Response.Write(message); %>
                    </div>
                <% } %>
